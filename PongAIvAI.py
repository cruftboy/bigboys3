...
class fRect:
    ...
    def get_angle(self, y):
        center = self.pos[1]+self.size[1]/2
...
def init_game():
    ...
    paddles[0].move_getter = chaser_ai.pong_chaser
    paddles[1].move_getter = chaser_ai.pong_trainerRIGHT #directions_from_input # chaser_ai.pong_ai
